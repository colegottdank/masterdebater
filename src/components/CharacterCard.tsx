      ...
      {onSelect ? (
        ...
        >
          ...
          <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50 pointer-events-none">
            <div className="bg-white text-black text-xs sm:text-sm font-bold p-2 sm:p-3 rounded-lg border-2 border-black max-w-[160px] sm:max-w-none whitespace-normal sm:whitespace-nowrap text-center">
              {character.quote}
